/*
Implements college Gauss Jordan. Solves $A * x = b$. If there are multiple solutions, an arbitrary one is returned. Returns rank, or $-1$ if no solutions. Data in $A$ and $b$ is lost.\\
Complexity: $O(n^2m)$\\
How to: \\
\begin{itemize}
...
\end{itemize}
---
Source: KACTL - https://github.com/kth-competitive-programming/kactl/blob/main/content/numerical/SolveLinear.h
